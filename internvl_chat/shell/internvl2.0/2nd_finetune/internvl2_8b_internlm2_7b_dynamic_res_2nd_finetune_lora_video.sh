...
# OUTPUT_DIR="/mnt/data/ruian/internvl2/internvl2_8b_internlm2_7b_dynamic_res_2nd_finetune_lora_${TIMESTAMP}_${LR}_mimic_gpt"
OUTPUT_DIR="/root/projects/InternVL-Epsi/internvl_chat/output"
...
torchrun \
  ...
  --meta_path "./shell/data/video_test.json" \
